...
export default function Jumbotron({
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-9rem)] overflow-hidden px-6 py-20 dark:bg-[#171421]">
      ...
      />
      <div className="relative z-10 m-auto flex max-w-4xl flex-col items-center gap-8 text-center before:absolute before:-left-12 before:-top-16 before:-z-10 before:size-28 before:rotate-12 before:rounded-[2rem] before:border-2 before:border-purple-300/50 after:absolute after:-bottom-16 after:-right-12 after:-z-10 after:size-24 after:rounded-full after:border-2 after:border-orange-300/60 sm:gap-10">
        {children}
      </div>
    </section>
  );
