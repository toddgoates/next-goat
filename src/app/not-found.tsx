      ...
      <Container extraSpace>
        <div className="relative grid items-center gap-14 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
          <div className="text-center lg:text-left">
            <p className="mb-4 text-sm font-bold tracking-[0.22em] text-purple-600 uppercase dark:text-purple-300">
              Well, this is awkward
            </p>
            <h1 className="text-7xl leading-[0.85] font-black text-balance text-slate-900 sm:text-8xl lg:text-9xl dark:text-white">
              4<span className="text-purple-500">0</span>
              <span className="text-orange-500">4</span>
            </h1>
            <h2 className="mt-7 text-3xl font-black text-balance sm:text-4xl">
          ...
          <div className="relative mx-auto w-full max-w-xl lg:mx-0">
            <div
              aria-hidden="true"
              className="absolute -inset-4 rotate-3 rounded-[2.5rem] bg-linear-to-br from-purple-500 to-orange-400 opacity-80"
            />
            <div className="relative -rotate-2 overflow-hidden rounded-4xl border-8 border-white bg-white shadow-[0_30px_80px_-30px_rgba(88,28,135,.65)] transition-transform duration-500 hover:rotate-0 dark:border-[#2c2540] dark:bg-[#2c2540]">
              <img
